...
namespace Employees.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var employeesContext = _context.Employee.Include(e => e.Position);
        ...
        {
            new Position { PositionId = 4, PositionName = "InfoSec Specialist" },
            new Position { PositionId = 5, PositionName = "Web Developer" },
            new Position { PositionId = 6, PositionName = "Software Developer" }
        };
